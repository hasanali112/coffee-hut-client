            ...
            {/* row-1  */}
             <div className="md:flex">
               <div className="form-control md:w-1/2">
                 ...
                 <label >
                   <input type="text" name="name" defaultValue={name} placeholder="Enter your name" className="input input-bordered w-full" />
                 </label>
               </div>
             ...
             <div className="md:flex">
               ...
               <div className="form-control md:w-1/2 md:ml-4">
                 ...
                 <label >
                   <input type="text" name="detail" defaultValue={detail} placeholder="Detail" className="input input-bordered w-full" />
                 </label>
               </div>
             </div>
             {/* row-4  */}
